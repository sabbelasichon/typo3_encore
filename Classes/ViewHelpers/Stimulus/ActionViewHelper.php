...
final class ActionViewHelper extends AbstractViewHelper
{
    ...
    {
        $this->registerArgument('dataOrControllerName', 'string|array', 'This can either be a map of controller names as keys set to their "values". Or this can be a string controller name and data is passed as the 2nd argument.', true);
        $this->registerArgument('eventName', 'string', 'The action to trigger if a string is passed to the 1st argument. Optional.', false);
        $this->registerArgument('actionName', 'string', 'The event to listen to trigger if a string is passed to the 1st argument. Optional.', false);
    }
